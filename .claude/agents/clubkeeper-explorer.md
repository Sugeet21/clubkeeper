...
4. **For "what does the skill say about X" questions:** Grep the relevant reference file (`ripple_effects.md`, `bug_patterns.md`, `history/sync_architecture_v2.md`, `data_model.md`, `design_system.md`), then read the matched section. Quote the relevant lines back; do not paraphrase critical rules.
