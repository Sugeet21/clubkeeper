...
**Last verified: 12 Jul 2026 (CLI session — D8 Settings staff management shipped (create/reset/revoke, show-once creds, name-only list), reviewer PASS, build+tsc clean at 117 baseline; endpoint round-trip folds into D9's vercel-dev run).**
