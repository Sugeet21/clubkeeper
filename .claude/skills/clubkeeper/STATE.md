...
**Last verified: 12 Jul 2026 (CLI session — D8 Settings staff management shipped; #129 one-time boot backfill shipped + runtime-proven (prod now mirrors local across all 9 tables), D9 step-2 blocker cleared; reviewer PASS on both, build+tsc clean at 117 baseline).**
