...
14 Jun 2026 — fix #70 (9f7e2aa): Summary TopTablesList + HourlyHeatmap now tick live. Root cause: useMemo with detailSessions dep — object reference doesn't change on useTick() re-renders. Fix: removed useMemo wrappers so rankTables + bucketByHour recompute inline on every render. Pattern T4 in bug_patterns.md updated with useMemo addendum.
