...
Last updated: 3 Jul 2026 (Chunk 5.3 — realtime direct-apply LWW handler via serialized job queue, doorbell demoted to fallback; DEV `__force_no_claim__` toggle in syncClubId + `window.__supabase` for #116 proof)
