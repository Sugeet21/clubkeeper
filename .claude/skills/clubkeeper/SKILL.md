...
- **Low-stock threshold (#92)** — Owner-configurable cutoff (1–999, default 5). Settings → Club Info → "Low stock alert at". All surfaces use `getLowStockThreshold()` with `?? 5` fallback. Rides Dexie v18 as additive optional. Pending owner verification.
