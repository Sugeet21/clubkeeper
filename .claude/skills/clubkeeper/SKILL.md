...
*Last updated: 9 Jun 2026 (Back Entries Phase 1 + Phase 2 — Log Past Session with canteen items)*
...
- **v12 (current, 9 Jun 2026): adds optional `isBackEntry?: boolean` on sessions. No new index. No `.upgrade()`. Legacy rows read `undefined` (falsy).**
